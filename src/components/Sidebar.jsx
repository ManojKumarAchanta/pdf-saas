...
const Sidebar = () => {
  ...
  const width = sidebarCollapsed
    ? appConfig.sidebar.collapsedWidth
    : appConfig.sidebar.width;
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-0 left-0 h-full bg-white border-r border-gray-200 z-50 transition-all duration-200 ${
